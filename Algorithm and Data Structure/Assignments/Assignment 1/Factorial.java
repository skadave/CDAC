...
//Time Complexity -> O(n) -> Since the n will keep decrementing until 1 is reached in each call, so n recursive calls are made
//Space Complexity -> O(n) -> as new stack frame per call will get space in memory n times